...
## 🚀 How to use the app
1. **Run the app:** You can download the executable from the release page, use the online version hosted on GitHub Pages, or build and run the app yourself (instructions provided below).
